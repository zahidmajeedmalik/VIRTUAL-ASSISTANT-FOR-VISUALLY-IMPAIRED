...
while (True):
    ...
    if cv2.waitKey(1) & 0xFF == ord('c'):
        res=inference(frame,'COCO')
        cv2.putText(img=frame, text=res, org=(50, 30), fontFace=cv2.FONT_HERSHEY_TRIPLEX, fontScale=1,color=(0, 255, 0), thickness=1 ,lineType = cv2.LINE_AA)
